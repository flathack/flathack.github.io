...
MILESTONES = [
    {"version": "v0.8.2", "label": "released", "pct": 82, "state": "done"},
...
def draw_brand(draw: ImageDraw.ImageDraw) -> None:
    ...
    text(draw, (33, 55), "v0.8.2", FONT_MONO, rgba(GREEN, 255))
...
def draw_progress(draw: ImageDraw.ImageDraw, phase: float) -> None:
    ...
    text(draw, (216, 34), "v0.9.0 in progress after v0.8.2 release", FONT_BODY, rgba(MUTED, 235))
